            ...
            if (typeVal != null) {
                ...
                if (entry != null) {
                    ...
                    if ((img == null || bytes == null) && (filePath == null || !await FileSystem.FileSystemProvider.FileExistsAsync(filePath))) {
                        ...
                        string addonUrl = VersionManager.GetAddOnNamedUrl(package.Domain, package.Product, "Image");//$$$$.GetAddOnTemplateUrl(package.Domain, package.Product, "Image");// and the Url of the Image template
