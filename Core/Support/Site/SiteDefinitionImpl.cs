    ...
    public partial class SiteDefinition : IInitializeApplicationStartup {
        ...
        public string GetFavIconLinks(string imageType, byte[]? data, string? name, string? imageTypeLarge, byte[]? dataLrg, string? nameLrg) {
            ...
            if (data != null && data.Length > 0) {
                ...
                hb.Append("<link rel='icon' type='image/png' href='{0}' sizes='32x32' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageType, null, name, 16, 16, Stretch: true);
                hb.Append("<link rel='icon' type='image/png' href='{0}' sizes='16x16' />", Utility.HE(url));
                // apple-touch
                url = ImageHTML.FormatUrl(imageType, null, name, 57, 57, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='57x57' href='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageType, null, name, 60, 60, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='60x60' href='{0}' />", Utility.HE(url));
            }
            if (!string.IsNullOrWhiteSpace(imageTypeLarge) && dataLrg != null && dataLrg.Length > 0) {
                ...
                hb.Append("<link rel='icon' type='image/png' href='{0}' sizes='196x196' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 96, 96, Stretch: true);
                hb.Append("<link rel='icon' type='image/png' href='{0}' sizes='96x96' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 128, 128, Stretch: true);
                hb.Append("<link rel='icon' type='image/png' href='{0}' sizes='128x128' />", Utility.HE(url));
                // apple-touch
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 114, 114, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='114x114' href='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 72, 72, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='72x72' href='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 144, 144, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='144x144' href='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 120, 120, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='120x120' href='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 76, 76, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='76x76' href='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 152, 152, Stretch: true);
                hb.Append("<link rel='apple-touch-icon' sizes='152x152' href='{0}' />", Utility.HE(url));
                // msbs
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 144, 144, Stretch: true);
                hb.Append("<meta name='msapplication-TileImage' content='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 70, 70, Stretch: true);
                hb.Append("<meta name='msapplication-square70x70logo' content='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 150, 150, Stretch: true);
                hb.Append("<meta name='msapplication-square150x150logo' content='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 310, 150, Stretch: true);
                hb.Append("<meta name='msapplication-wide310x150logo' content='{0}' />", Utility.HE(url));
                url = ImageHTML.FormatUrl(imageTypeLarge, null, nameLrg, 310, 310, Stretch: true);
                hb.Append("<meta name='msapplication-square310x310logo' content='{0}' />", Utility.HE(url));
