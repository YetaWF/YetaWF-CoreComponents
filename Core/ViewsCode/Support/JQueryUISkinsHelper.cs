...
#if MVC6
        public static async Task<HtmlString> RenderJQueryUISkinsAsync(this IHtmlHelper htmlHelper, string name, string selection, object HtmlAttributes = null) {
#else
        public static async Task<HtmlString> RenderJQueryUISkinsAsync(this HtmlHelper htmlHelper, string name, string selection, object HtmlAttributes = null) {
#endif
            ...
            if (useDefault)
                ...
                selection = await SkinAccess.GetJQueryUIDefaultSkinAsync();
