...
namespace YetaWF.Core.Models.Attributes {
    ...
    public class EmailValidationAttribute : DataTypeAttribute, IClientValidatable {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context) {
            ErrorMessage = __ResStr("valEmail2", "The email address for {0} is invalid - it should be in the format 'user@domain.com'", AttributeHelper.GetPropertyCaption(metadata));
