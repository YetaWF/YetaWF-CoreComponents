...
namespace System.Linq.Dynamic {
    ...
    public abstract class DynamicClass
    {
        public override string ToString() {
            PropertyInfo[] props = ObjectSupport.GetProperties(this.GetType()).ToArray();
    ...
    internal class ExpressionParser
    {
        ...
        interface IRelationalSignatures : IArithmeticSignatures
        {
            ...
            void F(char? x, char? y);
            void F(DateTime? x, DateTime? y);
            void F(MultiString x, MultiString y);
        }
...
#pragma warning restore 0219
        ...
        Expression ParseNew() {
            ...
            for (int i = 0; i < bindings.Length; i++)
                bindings[i] = Expression.Bind(ObjectSupport.GetProperty(type, properties[i].Name), expressions[i]);
        ...
        Expression ParseMemberAccess(Type type, Expression instance) {
            ...
            NextToken();
            if (token.id == TokenId.OpenParen) {
                if (instance != null && type != typeof(string) && type != typeof(MultiString)) {
